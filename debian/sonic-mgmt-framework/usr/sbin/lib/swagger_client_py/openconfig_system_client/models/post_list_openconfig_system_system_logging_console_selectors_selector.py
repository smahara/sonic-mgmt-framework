...
class PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector(object):
    ...
    def __init__(self, openconfig_systemselector=None):  # noqa: E501
        """PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_systemselector(self):
        """Gets the openconfig_systemselector of this PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector.  # noqa: E501


        :return: The openconfig_systemselector of this PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector.  # noqa: E501
    ...
    def openconfig_systemselector(self, openconfig_systemselector):
        """Sets the openconfig_systemselector of this PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector.


        :param openconfig_systemselector: The openconfig_systemselector of this PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostListOpenconfigSystemSystemLoggingConsoleSelectorsSelector):
            return False
