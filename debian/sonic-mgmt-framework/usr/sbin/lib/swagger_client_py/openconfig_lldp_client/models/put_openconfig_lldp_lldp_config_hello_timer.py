...
class PutOpenconfigLldpLldpConfigHelloTimer(object):
    ...
    def __init__(self, openconfig_lldphello_timer=None):  # noqa: E501
        """PutOpenconfigLldpLldpConfigHelloTimer - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_lldphello_timer(self):
        """Gets the openconfig_lldphello_timer of this PutOpenconfigLldpLldpConfigHelloTimer.  # noqa: E501


        :return: The openconfig_lldphello_timer of this PutOpenconfigLldpLldpConfigHelloTimer.  # noqa: E501
        :rtype: int
        """
    ...
    def openconfig_lldphello_timer(self, openconfig_lldphello_timer):
        """Sets the openconfig_lldphello_timer of this PutOpenconfigLldpLldpConfigHelloTimer.


        :param openconfig_lldphello_timer: The openconfig_lldphello_timer of this PutOpenconfigLldpLldpConfigHelloTimer.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PutOpenconfigLldpLldpConfigHelloTimer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutOpenconfigLldpLldpConfigHelloTimer):
            return False
