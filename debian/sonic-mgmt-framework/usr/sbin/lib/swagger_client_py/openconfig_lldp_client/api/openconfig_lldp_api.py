...
class OpenconfigLldpApi(object):
    ...
    def del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement(self, suppress_tlv_advertisement, **kwargs):  # noqa: E501
        """del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement  # noqa: E501
        ...
        >>> thread = api.del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement(suppress_tlv_advertisement, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str suppress_tlv_advertisement: Indicates whether the local system should suppress the advertisement of particular TLVs with the LLDP PDUs that it transmits. Where a TLV type is specified within this list, it should not be included in any LLDP PDU transmitted by the local agent. (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, **kwargs)  # noqa: E501
        else:
            (data) = self.del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, **kwargs)  # noqa: E501
            return data

    def del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(self, suppress_tlv_advertisement, **kwargs):  # noqa: E501
        """del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement  # noqa: E501

        OperationId: del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement Indicates whether the local system should suppress the advertisement of particular TLVs with the LLDP PDUs that it transmits. Where a TLV type is specified within this list, it should not be included in any LLDP PDU transmitted by the local agent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['suppress_tlv_advertisement']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'suppress_tlv_advertisement' is set
        if ('suppress_tlv_advertisement' not in params or
                params['suppress_tlv_advertisement'] is None):
            raise ValueError("Missing the required parameter `suppress_tlv_advertisement` when calling `del_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'suppress_tlv_advertisement' in params:
            path_params['suppress-tlv-advertisement'] = params['suppress_tlv_advertisement']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/openconfig-lldp:lldp/config/suppress-tlv-advertisement={suppress-tlv-advertisement}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement(self, suppress_tlv_advertisement, **kwargs):  # noqa: E501
        """get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement  # noqa: E501

        OperationId: get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement Indicates whether the local system should suppress the advertisement of particular TLVs with the LLDP PDUs that it transmits. Where a TLV type is specified within this list, it should not be included in any LLDP PDU transmitted by the local agent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement(suppress_tlv_advertisement, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, **kwargs)  # noqa: E501
        else:
            (data) = self.get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, **kwargs)  # noqa: E501
            return data

    def get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(self, suppress_tlv_advertisement, **kwargs):  # noqa: E501
        """get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement  # noqa: E501

        OperationId: get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement Indicates whether the local system should suppress the advertisement of particular TLVs with the LLDP PDUs that it transmits. Where a TLV type is specified within this list, it should not be included in any LLDP PDU transmitted by the local agent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement_with_http_info(suppress_tlv_advertisement, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'suppress_tlv_advertisement' is set
        if ('suppress_tlv_advertisement' not in params or
                params['suppress_tlv_advertisement'] is None):
            raise ValueError("Missing the required parameter `suppress_tlv_advertisement` when calling `get_llist_openconfig_lldp_lldp_config_suppress_tlv_advertisement`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/openconfig-lldp:lldp/config/suppress-tlv-advertisement={suppress-tlv-advertisement}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
