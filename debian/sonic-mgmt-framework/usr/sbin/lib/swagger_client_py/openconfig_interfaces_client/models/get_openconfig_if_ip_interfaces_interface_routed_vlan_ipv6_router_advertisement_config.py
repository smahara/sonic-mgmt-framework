...
class GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig(object):
    ...
    def __init__(self, openconfig_if_ipconfig=None):  # noqa: E501
        """GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_if_ipconfig(self):
        """Gets the openconfig_if_ipconfig of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig.  # noqa: E501


        :return: The openconfig_if_ipconfig of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig.  # noqa: E501
    ...
    def openconfig_if_ipconfig(self, openconfig_if_ipconfig):
        """Sets the openconfig_if_ipconfig of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig.


        :param openconfig_if_ipconfig: The openconfig_if_ipconfig of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv6RouterAdvertisementConfig):
            return False
