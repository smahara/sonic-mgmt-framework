...
class GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters(object):
    ...
    def __init__(self, openconfig_if_ipcounters=None):  # noqa: E501
        """GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_if_ipcounters(self):
        """Gets the openconfig_if_ipcounters of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters.  # noqa: E501


        :return: The openconfig_if_ipcounters of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters.  # noqa: E501
    ...
    def openconfig_if_ipcounters(self, openconfig_if_ipcounters):
        """Sets the openconfig_if_ipcounters of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters.


        :param openconfig_if_ipcounters: The openconfig_if_ipcounters of this GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4StateCounters):
            return False
