...
class OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking(object):
    ...
    def __init__(self, openconfig_if_ipinterface_tracking=None):  # noqa: E501
        """OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_if_ipinterface_tracking(self):
        """Gets the openconfig_if_ipinterface_tracking of this OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking.  # noqa: E501


        :return: The openconfig_if_ipinterface_tracking of this OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking.  # noqa: E501
    ...
    def openconfig_if_ipinterface_tracking(self, openconfig_if_ipinterface_tracking):
        """Sets the openconfig_if_ipinterface_tracking of this OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking.


        :param openconfig_if_ipinterface_tracking: The openconfig_if_ipinterface_tracking of this OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTracking):
            return False
