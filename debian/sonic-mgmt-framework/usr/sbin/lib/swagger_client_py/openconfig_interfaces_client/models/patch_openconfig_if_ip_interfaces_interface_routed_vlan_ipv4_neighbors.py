...
class PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors(object):
    ...
    def __init__(self, openconfig_if_ipneighbors=None):  # noqa: E501
        """PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_if_ipneighbors(self):
        """Gets the openconfig_if_ipneighbors of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors.  # noqa: E501


        :return: The openconfig_if_ipneighbors of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors.  # noqa: E501
    ...
    def openconfig_if_ipneighbors(self, openconfig_if_ipneighbors):
        """Sets the openconfig_if_ipneighbors of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors.


        :param openconfig_if_ipneighbors: The openconfig_if_ipneighbors of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Neighbors):
            return False
