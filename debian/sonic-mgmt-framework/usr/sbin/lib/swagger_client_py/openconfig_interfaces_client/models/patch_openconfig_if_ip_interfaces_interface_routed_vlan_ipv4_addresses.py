...
class PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses(object):
    ...
    def __init__(self, openconfig_if_ipaddresses=None):  # noqa: E501
        """PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_if_ipaddresses(self):
        """Gets the openconfig_if_ipaddresses of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses.  # noqa: E501


        :return: The openconfig_if_ipaddresses of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses.  # noqa: E501
    ...
    def openconfig_if_ipaddresses(self, openconfig_if_ipaddresses):
        """Sets the openconfig_if_ipaddresses of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses.


        :param openconfig_if_ipaddresses: The openconfig_if_ipaddresses of this PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchOpenconfigIfIpInterfacesInterfaceRoutedVlanIpv4Addresses):
            return False
