...
class PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig(object):
    ...
    def __init__(self, openconfig_platformconfig=None):  # noqa: E501
        """PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_platformconfig(self):
        """Gets the openconfig_platformconfig of this PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig.  # noqa: E501


        :return: The openconfig_platformconfig of this PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig.  # noqa: E501
    ...
    def openconfig_platformconfig(self, openconfig_platformconfig):
        """Sets the openconfig_platformconfig of this PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig.


        :param openconfig_platformconfig: The openconfig_platformconfig of this PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchOpenconfigPlatformComponentsComponentSubcomponentsSubcomponentConfig):
            return False
