...
class PostListOpenconfigPlatformComponentsComponentPropertiesProperty(object):
    ...
    def __init__(self, openconfig_platformproperty=None):  # noqa: E501
        """PostListOpenconfigPlatformComponentsComponentPropertiesProperty - a model defined in Swagger"""  # noqa: E501
    ...
    def openconfig_platformproperty(self):
        """Gets the openconfig_platformproperty of this PostListOpenconfigPlatformComponentsComponentPropertiesProperty.  # noqa: E501


        :return: The openconfig_platformproperty of this PostListOpenconfigPlatformComponentsComponentPropertiesProperty.  # noqa: E501
    ...
    def openconfig_platformproperty(self, openconfig_platformproperty):
        """Sets the openconfig_platformproperty of this PostListOpenconfigPlatformComponentsComponentPropertiesProperty.


        :param openconfig_platformproperty: The openconfig_platformproperty of this PostListOpenconfigPlatformComponentsComponentPropertiesProperty.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostListOpenconfigPlatformComponentsComponentPropertiesProperty, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostListOpenconfigPlatformComponentsComponentPropertiesProperty):
            return False
