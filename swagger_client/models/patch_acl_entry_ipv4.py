...
class PatchAclEntryIpv4(AclEntryIpv4):
    ...
    def __init__(self):  # noqa: E501
        """PatchAclEntryIpv4 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchAclEntryIpv4, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchAclEntryIpv4):
            return False
