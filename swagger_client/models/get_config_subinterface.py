...
class GetConfigSubinterface(object):
    ...
    def __init__(self, subinterface=None):  # noqa: E501
        """GetConfigSubinterface - a model defined in Swagger"""  # noqa: E501
    ...
    def subinterface(self):
        """Gets the subinterface of this GetConfigSubinterface.  # noqa: E501


        :return: The subinterface of this GetConfigSubinterface.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetConfigSubinterface, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConfigSubinterface):
            return False
