...
from swagger_client.models.l2_config import L2Config  # noqa: F401,E501


class PatchL2Config(L2Config):
    ...
    def __init__(self):  # noqa: E501
        """PatchL2Config - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchL2Config, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchL2Config):
            return False
