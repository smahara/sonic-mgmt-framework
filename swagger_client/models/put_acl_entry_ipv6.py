...
class PutAclEntryIpv6(AclEntryIpv6):
    ...
    def __init__(self):  # noqa: E501
        """PutAclEntryIpv6 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PutAclEntryIpv6, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutAclEntryIpv6):
            return False
