...
class PatchAclEntryL2(AclEntryL2):
    ...
    def __init__(self):  # noqa: E501
        """PatchAclEntryL2 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchAclEntryL2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchAclEntryL2):
            return False
