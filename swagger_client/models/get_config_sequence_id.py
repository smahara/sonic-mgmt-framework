...
class GetConfigSequenceId(object):
    ...
    def __init__(self, sequence_id=None):  # noqa: E501
        """GetConfigSequenceId - a model defined in Swagger"""  # noqa: E501
    ...
    def sequence_id(self):
        """Gets the sequence_id of this GetConfigSequenceId.  # noqa: E501


        :return: The sequence_id of this GetConfigSequenceId.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetConfigSequenceId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetConfigSequenceId):
            return False
