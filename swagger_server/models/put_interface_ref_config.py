...
class PutInterfaceRefConfig(Model):
    ...
    def __init__(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig=None):  # noqa: E501
        """PutInterfaceRefConfig - a model defined in Swagger

        :param openconfig_aclconfig: The openconfig_aclconfig of this PutInterfaceRefConfig.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PutInterfaceRefConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The put_interface_ref_config of this PutInterfaceRefConfig.  # noqa: E501
        :rtype: PutInterfaceRefConfig
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclconfig(self) -> AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig:
        """Gets the openconfig_aclconfig of this PutInterfaceRefConfig.


        :return: The openconfig_aclconfig of this PutInterfaceRefConfig.
    ...
    def openconfig_aclconfig(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig):
        """Sets the openconfig_aclconfig of this PutInterfaceRefConfig.


        :param openconfig_aclconfig: The openconfig_aclconfig of this PutInterfaceRefConfig.
        :type openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig
        """
