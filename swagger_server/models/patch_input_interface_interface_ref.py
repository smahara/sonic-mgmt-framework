...
class PatchInputInterfaceInterfaceRef(Model):
    ...
    def __init__(self, openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref=None):  # noqa: E501
        """PatchInputInterfaceInterfaceRef - a model defined in Swagger

        :param openconfig_aclinterface_ref: The openconfig_aclinterface_ref of this PatchInputInterfaceInterfaceRef.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PatchInputInterfaceInterfaceRef':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The patch_input_interface_interface_ref of this PatchInputInterfaceInterfaceRef.  # noqa: E501
        :rtype: PatchInputInterfaceInterfaceRef
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclinterface_ref(self) -> AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref:
        """Gets the openconfig_aclinterface_ref of this PatchInputInterfaceInterfaceRef.


        :return: The openconfig_aclinterface_ref of this PatchInputInterfaceInterfaceRef.
    ...
    def openconfig_aclinterface_ref(self, openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref):
        """Sets the openconfig_aclinterface_ref of this PatchInputInterfaceInterfaceRef.


        :param openconfig_aclinterface_ref: The openconfig_aclinterface_ref of this PatchInputInterfaceInterfaceRef.
        :type openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref
        """
