...
class PostIpv4Config(Model):
    ...
    def __init__(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesIpv4Config=None):  # noqa: E501
        """PostIpv4Config - a model defined in Swagger

        :param openconfig_aclconfig: The openconfig_aclconfig of this PostIpv4Config.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PostIpv4Config':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The post_ipv4_config of this PostIpv4Config.  # noqa: E501
        :rtype: PostIpv4Config
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclconfig(self) -> AclOpenconfigaclaclAclsetsAclentriesIpv4Config:
        """Gets the openconfig_aclconfig of this PostIpv4Config.


        :return: The openconfig_aclconfig of this PostIpv4Config.
    ...
    def openconfig_aclconfig(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesIpv4Config):
        """Sets the openconfig_aclconfig of this PostIpv4Config.


        :param openconfig_aclconfig: The openconfig_aclconfig of this PostIpv4Config.
        :type openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesIpv4Config
        """
