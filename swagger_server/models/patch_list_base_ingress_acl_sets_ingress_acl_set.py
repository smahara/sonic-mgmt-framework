...
class PatchListBaseIngressAclSetsIngressAclSet(Model):
    ...
    def __init__(self, openconfig_aclingress_acl_set: List[AclOpenconfigaclaclInterfacesIngressaclsetsIngressaclset]=None):  # noqa: E501
        """PatchListBaseIngressAclSetsIngressAclSet - a model defined in Swagger

        :param openconfig_aclingress_acl_set: The openconfig_aclingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PatchListBaseIngressAclSetsIngressAclSet':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The patch_list_base_ingress_acl_sets_ingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.  # noqa: E501
        :rtype: PatchListBaseIngressAclSetsIngressAclSet
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclingress_acl_set(self) -> List[AclOpenconfigaclaclInterfacesIngressaclsetsIngressaclset]:
        """Gets the openconfig_aclingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.


        :return: The openconfig_aclingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.
    ...
    def openconfig_aclingress_acl_set(self, openconfig_aclingress_acl_set: List[AclOpenconfigaclaclInterfacesIngressaclsetsIngressaclset]):
        """Sets the openconfig_aclingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.


        :param openconfig_aclingress_acl_set: The openconfig_aclingress_acl_set of this PatchListBaseIngressAclSetsIngressAclSet.
        :type openconfig_aclingress_acl_set: List[AclOpenconfigaclaclInterfacesIngressaclsetsIngressaclset]
        """
