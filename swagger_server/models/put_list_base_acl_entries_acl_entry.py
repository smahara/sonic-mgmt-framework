...
class PutListBaseAclEntriesAclEntry(Model):
    ...
    def __init__(self, openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]=None):  # noqa: E501
        """PutListBaseAclEntriesAclEntry - a model defined in Swagger

        :param openconfig_aclacl_entry: The openconfig_aclacl_entry of this PutListBaseAclEntriesAclEntry.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PutListBaseAclEntriesAclEntry':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The put_list_base_acl_entries_acl_entry of this PutListBaseAclEntriesAclEntry.  # noqa: E501
        :rtype: PutListBaseAclEntriesAclEntry
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclacl_entry(self) -> List[AclOpenconfigaclaclAclsetsAclentriesAclentry]:
        """Gets the openconfig_aclacl_entry of this PutListBaseAclEntriesAclEntry.


        :return: The openconfig_aclacl_entry of this PutListBaseAclEntriesAclEntry.
    ...
    def openconfig_aclacl_entry(self, openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]):
        """Sets the openconfig_aclacl_entry of this PutListBaseAclEntriesAclEntry.


        :param openconfig_aclacl_entry: The openconfig_aclacl_entry of this PutListBaseAclEntriesAclEntry.
        :type openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]
        """
