...
class PutInputInterfaceInterfaceRef(Model):
    ...
    def __init__(self, openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref=None):  # noqa: E501
        """PutInputInterfaceInterfaceRef - a model defined in Swagger

        :param openconfig_aclinterface_ref: The openconfig_aclinterface_ref of this PutInputInterfaceInterfaceRef.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PutInputInterfaceInterfaceRef':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The put_input_interface_interface_ref of this PutInputInterfaceInterfaceRef.  # noqa: E501
        :rtype: PutInputInterfaceInterfaceRef
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclinterface_ref(self) -> AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref:
        """Gets the openconfig_aclinterface_ref of this PutInputInterfaceInterfaceRef.


        :return: The openconfig_aclinterface_ref of this PutInputInterfaceInterfaceRef.
    ...
    def openconfig_aclinterface_ref(self, openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref):
        """Sets the openconfig_aclinterface_ref of this PutInputInterfaceInterfaceRef.


        :param openconfig_aclinterface_ref: The openconfig_aclinterface_ref of this PutInputInterfaceInterfaceRef.
        :type openconfig_aclinterface_ref: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfaceref
        """
