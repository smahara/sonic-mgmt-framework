...
class PostInterfaceRefConfig(Model):
    ...
    def __init__(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig=None):  # noqa: E501
        """PostInterfaceRefConfig - a model defined in Swagger

        :param openconfig_aclconfig: The openconfig_aclconfig of this PostInterfaceRefConfig.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PostInterfaceRefConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The post_interface_ref_config of this PostInterfaceRefConfig.  # noqa: E501
        :rtype: PostInterfaceRefConfig
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclconfig(self) -> AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig:
        """Gets the openconfig_aclconfig of this PostInterfaceRefConfig.


        :return: The openconfig_aclconfig of this PostInterfaceRefConfig.
    ...
    def openconfig_aclconfig(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig):
        """Sets the openconfig_aclconfig of this PostInterfaceRefConfig.


        :param openconfig_aclconfig: The openconfig_aclconfig of this PostInterfaceRefConfig.
        :type openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig
        """
