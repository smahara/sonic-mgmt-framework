...
class GetStateDestinationFlowLabel(Model):
    ...
    def __init__(self, destination_flow_label: int=None):  # noqa: E501
        """GetStateDestinationFlowLabel - a model defined in Swagger
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'GetStateDestinationFlowLabel':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The get_state_destination_flow_label of this GetStateDestinationFlowLabel.  # noqa: E501
    ...
    def destination_flow_label(self) -> int:
        """Gets the destination_flow_label of this GetStateDestinationFlowLabel.


        :return: The destination_flow_label of this GetStateDestinationFlowLabel.
        :rtype: int
        """
    ...
    def destination_flow_label(self, destination_flow_label: int):
        ...
        :param destination_flow_label: The destination_flow_label of this GetStateDestinationFlowLabel.
        :type destination_flow_label: int
        """
