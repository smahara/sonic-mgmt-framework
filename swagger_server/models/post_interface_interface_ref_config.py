...
class PostInterfaceInterfaceRefConfig(Model):
    ...
    def __init__(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig=None):  # noqa: E501
        """PostInterfaceInterfaceRefConfig - a model defined in Swagger

        :param openconfig_aclconfig: The openconfig_aclconfig of this PostInterfaceInterfaceRefConfig.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PostInterfaceInterfaceRefConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The post_interface_interface_ref_config of this PostInterfaceInterfaceRefConfig.  # noqa: E501
        :rtype: PostInterfaceInterfaceRefConfig
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclconfig(self) -> AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig:
        """Gets the openconfig_aclconfig of this PostInterfaceInterfaceRefConfig.


        :return: The openconfig_aclconfig of this PostInterfaceInterfaceRefConfig.
    ...
    def openconfig_aclconfig(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig):
        """Sets the openconfig_aclconfig of this PostInterfaceInterfaceRefConfig.


        :param openconfig_aclconfig: The openconfig_aclconfig of this PostInterfaceInterfaceRefConfig.
        :type openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesInputinterfaceInterfacerefConfig
        """
