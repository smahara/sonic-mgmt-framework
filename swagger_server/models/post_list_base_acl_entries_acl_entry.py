...
class PostListBaseAclEntriesAclEntry(Model):
    ...
    def __init__(self, openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]=None):  # noqa: E501
        """PostListBaseAclEntriesAclEntry - a model defined in Swagger

        :param openconfig_aclacl_entry: The openconfig_aclacl_entry of this PostListBaseAclEntriesAclEntry.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PostListBaseAclEntriesAclEntry':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The post_list_base_acl_entries_acl_entry of this PostListBaseAclEntriesAclEntry.  # noqa: E501
        :rtype: PostListBaseAclEntriesAclEntry
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclacl_entry(self) -> List[AclOpenconfigaclaclAclsetsAclentriesAclentry]:
        """Gets the openconfig_aclacl_entry of this PostListBaseAclEntriesAclEntry.


        :return: The openconfig_aclacl_entry of this PostListBaseAclEntriesAclEntry.
    ...
    def openconfig_aclacl_entry(self, openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]):
        """Sets the openconfig_aclacl_entry of this PostListBaseAclEntriesAclEntry.


        :param openconfig_aclacl_entry: The openconfig_aclacl_entry of this PostListBaseAclEntriesAclEntry.
        :type openconfig_aclacl_entry: List[AclOpenconfigaclaclAclsetsAclentriesAclentry]
        """
