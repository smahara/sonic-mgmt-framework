...
class PatchActionsConfig(Model):
    ...
    def __init__(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesActionsConfig=None):  # noqa: E501
        """PatchActionsConfig - a model defined in Swagger

        :param openconfig_aclconfig: The openconfig_aclconfig of this PatchActionsConfig.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PatchActionsConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The patch_actions_config of this PatchActionsConfig.  # noqa: E501
        :rtype: PatchActionsConfig
        """
        return util.deserialize_model(dikt, cls)

    @property
    def openconfig_aclconfig(self) -> AclOpenconfigaclaclAclsetsAclentriesActionsConfig:
        """Gets the openconfig_aclconfig of this PatchActionsConfig.


        :return: The openconfig_aclconfig of this PatchActionsConfig.
    ...
    def openconfig_aclconfig(self, openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesActionsConfig):
        """Sets the openconfig_aclconfig of this PatchActionsConfig.


        :param openconfig_aclconfig: The openconfig_aclconfig of this PatchActionsConfig.
        :type openconfig_aclconfig: AclOpenconfigaclaclAclsetsAclentriesActionsConfig
        """
