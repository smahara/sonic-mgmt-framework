...
static int __init accton_pddf_fan_init(void)
{
...
static void __exit accton_pddf_fan_exit(void)
{
...
module_init(accton_pddf_fan_init);
module_exit(accton_pddf_fan_exit);
