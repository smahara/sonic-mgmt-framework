...
$(BRCM_SAI)_URL = "http://10.59.132.240:9009/projects/csg_sonic/sonic_builds/sai_debs/LATEST_INT_OCP_SAI_3.6/build/libsaibcm_3.6.0.1_amd64.deb"
...
ifeq ($(LOCAL_SAI_DEBS_PATH),)
$(BRCM_SAI_DEV)_URL = "http://10.59.132.240:9009/projects/csg_sonic/sonic_builds/sai_debs/LATEST_INT_OCP_SAI_3.6/build/libsaibcm-dev_3.6.0.1_amd64.deb"
else
