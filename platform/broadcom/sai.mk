...
ifneq ($(wildcard $(LOCAL_SAI_DEBS_PATH)),)
...
$(BRCM_SAI)_URL = "$(BRCM_SAI_URL)/$(BRCM_SAI)"
...
ifeq ($(LOCAL_SAI_DEBS_PATH),)
$(BRCM_SAI_DEV)_URL = "$(BRCM_SAI_URL)/$(BRCM_SAI_DEV)"
else
...
#BRCM_SAI_DIAG
ifeq ($(LOCAL_SAI_DEBS_PATH),)
$(BRCM_SAI_DIAG)_URL = "$(BRCM_SAI_URL)/$(BRCM_SAI_DIAG)"
