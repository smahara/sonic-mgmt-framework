...
QUANTA_IX4_64X_PLATFORM_MODULE_VERSION = 1.0
...
export QUANTA_IX4_64X_PLATFORM_MODULE_VERSION
...
QUANTA_IX4_64X_PLATFORM_MODULE = sonic-platform-quanta-ix4-64x_$(QUANTA_IX4_64X_PLATFORM_MODULE_VERSION)_amd64.deb
$(QUANTA_IX4_64X_PLATFORM_MODULE)_PLATFORM = x86_64-quanta_ix4_bwde-r0
$(eval $(call add_extra_package,$(QUANTA_IX1B_32X_PLATFORM_MODULE),$(QUANTA_IX4_64X_PLATFORM_MODULE)))
