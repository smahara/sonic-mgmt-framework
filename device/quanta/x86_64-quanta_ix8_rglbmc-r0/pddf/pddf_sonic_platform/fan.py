...
class Fan(PddfFan):
    ...
    def get_name(self):
        # Since IX8 has two fans in a tray, modifying this function to return proper name
        if self.is_psu_fan:
            return "PSU_FAN{}".format(self.fan_index)
        else:
            return "Fantry{}_{}".format(self.fantray_index, {1:'Front', 2:'Rear'}.get(self.fan_index,'none'))
