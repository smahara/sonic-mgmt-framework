...
class PsuUtil(PsuBase):
    ...
    PSU1_PREFIX = 'power88_'
    PSU2_PREFIX = 'power89_'
    MAX_PSUS = 2
    ...
    def get_direction(self, index):
        if (index == 1):
            direction_file = 'fan98_direction'
        elif (index == 2):
            direction_file = 'fan99_direction'
        else:
            logging.error("Invalid PSU number:", index)
            return None
    ...
    def get_output_voltage(self, index):
        if (index == 1):
            attr_file = 'in90_input'
        elif (index == 2):
            attr_file = 'in91_input'
        else:
            logging.error("Invalid PSU number:", index)
            return 0
    ...
    def get_output_current(self, index):
        if (index == 1):
            attr_file = 'curr94_input'
        elif (index == 2):
            attr_file = 'curr95_input'
        else:
            logging.error("Invalid PSU number:", index)
            return 0
    ...
    def get_fan_rpm(self, index, fan_idx):
        if (index == 1):
            rpm_file = 'fan98_input'
        elif (index == 2):
            rpm_file = 'fan99_input'
        else:
            logging.error("Invalid PSU number:", index)
            return 0
