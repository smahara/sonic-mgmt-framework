...
#if 0
		BPF_TR(" TEAMD : [%d] >> OLD :- "KEY_VALUE_FORMAT"\n", m_key.ifidx
				, kif_index
				, old_val->team_info.slave_info
				, old_val->team_info.master
				, old_val->team_info.flags
				, old_val->team_info.mac_addr[0], old_val->team_info.mac_addr[1], old_val->team_info.mac_addr[2]
				, old_val->team_info.mac_addr[3], old_val->team_info.mac_addr[4], old_val->team_info.mac_addr[5]
				, old_val->team_info.ppid.id[0], old_val->team_info.ppid.id[1], old_val->team_info.ppid.id[2]
				, old_val->team_info.ppid.id[3], old_val->team_info.ppid.id[4], old_val->team_info.ppid.id[5]
				);
		BPF_TR(" TEAMD : [%d] >> NEW :- "KEY_VALUE_FORMAT"\n", m_key.ifidx
				, kif_index
				, new_val.team_info.slave_info
				, new_val.team_info.master
				, new_val.team_info.flags
				, new_val.team_info.mac_addr[0], new_val.team_info.mac_addr[1], new_val.team_info.mac_addr[2]
				, new_val.team_info.mac_addr[3], new_val.team_info.mac_addr[4], new_val.team_info.mac_addr[5]
				, new_val.team_info.ppid.id[0], new_val.team_info.ppid.id[1], new_val.team_info.ppid.id[2]
				, new_val.team_info.ppid.id[3], new_val.team_info.ppid.id[4], new_val.team_info.ppid.id[5]
				);
#endif
