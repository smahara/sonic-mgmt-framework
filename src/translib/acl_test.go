...
// Verify sonic-acl post
func Test_SonicAcl_TopLevelPath(t *testing.T) {
        url := "/sonic-acl:sonic-acl"

        t.Run("Empty_Response_Top_Level", processGetRequest(url, emptyJson, false))

        t.Run("Bulk_Create_Top_Level", processSetRequest(url, bulkSonicAclCreateJsonRequest, "POST", false))

        t.Run("Get_Full_Acl_Tree_Top_Level", processGetRequest(url, bulkSonicAclCreateJsonResponse, false))
...
// Verify sonic-acl patch
func Test_SonicAcl_SingleAclOperations(t *testing.T) {
        url := "/sonic-acl:sonic-acl/ACL_RULE=[aclname=MyACL1_ACL_IPV4][rulename=RULE_1]"

        t.Run("Create_One_Sonic_Acl(PATCH)", processSetRequest(url, oneSonicAclCreateWithRulesJsonRequest, "PATCH", false))

        t.Run("Verify_Create_One_Sonic_Acl", processGetRequest(url, oneSonicAclCreateWithRulesJsonResponse, false))

        t.Run("Delete_One_Sonic_Acl", processDeleteRequest(url))

        t.Run("Verify_One_Sonic_Acl_Delete", processGetRequest(url, "", true))
}

// Verify sonic-acl replace
func Test_SonicAcl_ReplaceOneRule(t *testing.T) {
        url := "/sonic-acl:sonic-acl/ACL_RULE=[aclname=MyACL1_ACL_IPV4][rulename=RULE_1]"

        t.Run("Create_One_Sonic_Acl(PATCH)", processSetRequest(url, oneSonicAclCreateWithRulesJsonRequest, "PATCH", false))
        t.Run("Verify_Create_One_Sonic_Acl", processGetRequest(url, oneSonicAclCreateWithRulesJsonResponse, false))

        t.Run("Replace_One_Rule", processSetRequest(url, replaceOneRuleJsonRequest, "PUT", false))
        t.Run("Verify_Sonic_Acl_With_Replaced_Rule", processGetRequest(url, replaceOneRuleJsonResponse, false))
...
var bulksonicAclCreateJsonRequest string = "{\"ACL_TABLE\":[{\"aclname\":\"MyACL3_ACL_IPV4\",\"policy_desc\":\"Description for MyACL3\",\"stage\":\"EGRESS\",\"type\":\"L3\",\"ports\":[\"Ethernet0\"]},{\"aclname\":\"MyACL4_ACL_IPV4\",\"policy_desc\":\"Description for MyACL4\",\"stage\":\"EGRESS\",\"type\":\"L3\",\"ports\":[\"Ethernet4\",\"Ethernet8\"]}],\"ACL_RULE\":[{\"aclname\":\"MyACL3_ACL_IPV4\",\"rulename\":\"RULE_1\",\"PRIORITY\":65536,\"RULE_DESCRIPTION\":\"MyACL3_ACL_IPV4 rule description\",\"PACKET_ACTION\":\"FORWARD\",\"IP_TYPE\":\"ipv4\",\"IP_PROTOCOL\":6,\"SRC_IP\":\"10.1.1.1/32\",\"DST_IP\":\"20.2.2.2/32\",\"L4_SRC_PORT_RANGE\":\"13000-14000\",\"L4_DST_PORT_RANGE\":\"9000-12000\",\"DSCP\":2}]}"

var bulkSonicAclCreateJsonResponse string = ""

var oneSonicAclCreateWithRulesJsonRequest string ="{\"ACL_TABLE\": [{\"aclname\": \"MyACL1_ACL_IPV4\",\"policy_desc\": \"Description for MyACL1\"}],\"ACL_RULE\": [{\"aclname\": \"MyACL1_ACL_IPV4\",\"rulename\": \"RULE_1\",\"PRIORITY\": 65534,\"RULE_DESCRIPTION\": \"Description for MyACL1\",\"PACKET_ACTION\": \"FORWARD\",\"IP_TYPE\": \"ipv4\",\"IP_PROTOCOL\": 6,\"SRC_IP\": \"10.1.1.1/32\",\"DST_IP\": \"20.2.2.2/32\"}]}"

var oneSonicAclCreateWithRulesJsonRequest string =""

var replaceOneRuleJsonRequest string = "{\"ACL_TABLE\": [{\"aclname\": \"MyACL1_ACL_IPV4\",\"policy_desc\": \"Updated MyACL1\"}],\"ACL_RULE\": [{\"aclname\": \"MyACL1_ACL_IPV4\",\"rulename\": \"RULE_1\",\"PRIORITY\": 65536,\"RULE_DESCRIPTION\": \"Updated  MyACL1\",\"PACKET_ACTION\": \"FORWARD\",\"IP_TYPE\": \"ipv4\",\"IP_PROTOCOL\": 6,\"SRC_IP\": \"10.1.1.1/32\",\"DST_IP\": \"20.2.2.2/32\"}]}"

var replaceOneRuleJsonResponse string = ""
